...
public class AdapterPatient extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterPatient(Context context, List<DataPatient> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v)
        {
            ...
            Intent intent = new Intent(context, AdminPatientModifyPage.class);

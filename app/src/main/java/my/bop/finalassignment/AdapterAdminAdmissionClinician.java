...
public class AdapterAdminAdmissionClinician extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterAdminAdmissionClinician(Context context, List<DataClinician> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private void deleteClinician()
        {
            ...
            Intent intent = new Intent(context, AdminAdmissionClinicianPage.class);

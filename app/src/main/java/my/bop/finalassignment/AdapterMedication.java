...
public class AdapterMedication extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public AdapterMedication(Context context, List<DataMed> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        ...
        AdapterMedication.MyHolder holder=new AdapterMedication.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        AdapterMedication.MyHolder myHolder= (AdapterMedication.MyHolder) holder;
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v)
        {
            ...
            Intent intent = new Intent(context, ClientViewMedicationClientPage.class);
            intent.putExtra("mrn", mrnget);
            intent.putExtra("admissionid", admissionget);

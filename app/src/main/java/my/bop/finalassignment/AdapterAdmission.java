...
public class AdapterAdmission extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterAdmission(Context context, List<DataAdmission> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v)
        {
            ...
            String starttime = admission.getStartTime();
            String endtime = admission.getEndTime();
            String graphid = admission.getGraphid();
            String status = admission.getStatus();
            String paintype = admission.getPaintype();
            String painregion = admission.getPainregion();
            Intent intent = new Intent(context, ClientViewGraphPage.class);
            ...
            intent.putExtra("paintype", paintype);
            intent.putExtra("painregion", painregion);

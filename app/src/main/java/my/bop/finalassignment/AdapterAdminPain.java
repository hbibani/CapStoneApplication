...
public class AdapterAdminPain extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterAdminPain(Context context, List<DataClientPain> data){
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private void deleteGraphItem()
        {
            ...
            Intent intent = new Intent(context, AdminAdmissionModifyGraphPage.class);
